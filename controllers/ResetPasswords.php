...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = '42dda4574ca2e9';
        $this->mail->Password = '6ad385c55328f1';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/saveplantdonation/views/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
